...
core/voice.py
=============
Handles audio I/O for the terminal assistant and queues text for the web UI.
"""
...
class Voice:
    ...
    def _setup_tts(self):
        """Configure offline TTS when the terminal voice assistant needs it."""
        try:
    ...
    def speak(self, text: str):
        """Print, queue, and optionally speak the given text."""
        print(f"\n[Cynthia] {text}\n")
        if self.web_mode:
    ...
    def get_messages(self):
        """Consume and return messages for the web interface."""
    ...
    def listen(self) -> str:
        ...
        - text_mode: reads from keyboard
        - voice mode: listens on the microphone for up to 5 seconds
